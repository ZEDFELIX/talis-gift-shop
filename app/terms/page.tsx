...
const sections = [
  ...
  { title: "Delivery", body: "Estimated delivery windows are provided at checkout. While we work with reliable courier partners, timings may vary during high-demand seasons. Risk passes to the recipient on delivery." },
